...
import { addNewMessage, toggleSidebarList } from '@/features/messages/messagesSlice';
import { useRef, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';

export default function ChatApp() {
	const { selectedUser, showSidebarList, showDetail } = useSelector((state) => state.messages);
	...
	return (
		<div className={`max-w-7xl mx-auto chat-wrapper ${showSidebarList && 'min-h-[999px]'}`}>
			<MessageSidebar />
			<div
